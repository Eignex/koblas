...
class PackedPanelBenchmark {
    ...
    fun setup() {
        ...
        println(
            "resolved: packed-panels rows=${F64PackedPanels.tileRows} columns=${F64PackedPanels.tileColumns}",
        )
    }
...
class PackedPanelExecutionBenchmark {
    ...
    fun setup() {
        ...
        val rows = if (edge == "full") F64PackedPanels.tileRows else F64PackedPanels.tileRows - 1
        val columns = if (edge == "full") F64PackedPanels.tileColumns else F64PackedPanels.tileColumns - 1
        val rng = benchRng()
