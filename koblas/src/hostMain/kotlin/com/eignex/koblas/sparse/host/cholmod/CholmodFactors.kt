...
/**
 * `L` in CSC and the fill-reducing permutation, copied out of a converted factor. The diagonal is first in
 * each column, which is where an `L·D·Lᵀ` caller finds `D`.
 */
