...
public actual object F64BuiltinKernels {
    ...
    private val cProvider by lazy {
        if (CKernels.isAvailable) F64BuiltinKernelProvider(CKernels, F64CSparseKernels) else null
    }
    private val simdProvider by lazy {
        if (SimdKernels.isAvailable) F64BuiltinKernelProvider(SimdKernels, F64SimdSparseKernels) else null
    }
