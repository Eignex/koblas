 ...
 *
 * The bundled JVM C kernels try each candidate name in turn, keep the first that both loads and carries a
 * key symbol, and bind handles out of it lazily.
 *
...
internal class FfmLibrary private constructor(
    ...
    /**
     * Whether [name] is exported, read with `find`, which is a lookup rather than a binding.
     */
    ...
    public companion object {
        ...
        /**
         * Null where this platform has no native linker to hand out. Resolved defensively so an unavailable
         * linker leaves the scalar fallback usable instead of failing class initialization.
         */
