...
public actual object BuiltinEngines {
    ...
    public actual val simd: KoblasEngine? by lazy {
        if (SimdVectorKernels.isAvailable) {
            simdEngine(SimdPanelKernels, SimdProductKernels, SimdTriangularKernels)
        } else {
            null
        }
    }
    ...
    internal val defaultComposition: KoblasEngine? by lazy {
        if (SimdVectorKernels.isAvailable) {
            simdEngine(PortablePanelKernels, PortableProductKernels, PortableTriangularKernels)
        } else {
            null
        }
    }
