 ...
 */
internal class CholmodMatrix private constructor(private val block: NativeBlock, private val arena: Arena) :
    AutoCloseable {

    /** What the downcalls take, since a CHOLMOD routine is handed the struct by address. */
    val segment: MemorySegment get() = block.segment
    ...
    companion object {
        ...
        private fun of(a: F64SparseMatrix, stype: Int, arena: Arena): CholmodMatrix = try {
            CholmodMatrix(ArenaBlocks(arena).describeCholmodSparse(a, stype), arena)
