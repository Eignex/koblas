...
internal fun assertFactorIntoUsesItsDestination(decompositions: F64Decompositions, n: Int) {
    ...
    assertEquals(fresh.rowOrder().toList(), returned.rowOrder().toList(), "factorInto pivots n=$n")
...
internal fun assertRectangularLuAgreesWithReference(decompositions: F64Decompositions) {
    ...
    for (a in cases) {
        ...
        assertEquals(expected.rowOrder().toList(), actual.rowOrder().toList(), "pivots ${a.rows}x${a.cols}")
