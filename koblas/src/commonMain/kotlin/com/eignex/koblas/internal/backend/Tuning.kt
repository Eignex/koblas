 ...
 * what a test needs it to say. Blank counts as unset, as it does for a backend pin: a variable exported
 * empty is a deployment clearing an override rather than one asking for no value at all.
 *
