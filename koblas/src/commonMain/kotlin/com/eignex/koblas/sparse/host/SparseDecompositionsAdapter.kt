 ...
 */
public abstract class SparseDecompositionsAdapter protected constructor(
    ...
    protected val portable: ReferenceSparseDecompositions =
        ReferenceSparseDecompositions(equilibrate = equilibrate)
    ...
    override fun route(query: RouteQuery): BackendRoute? = when (query) {
        is RouteQuery.SparseLu, is RouteQuery.SparseQr ->
     ...
     */
    protected open fun nativeAvailableFor(query: RouteQuery): Boolean = nativeAvailable
    ...
    protected abstract fun factorNative(a: SparseMatrix): SparseLuFactorization

    final override fun cholesky(a: SparseMatrix): SparseCholeskyFactorization {
     ...
     */
    protected open fun choleskyNative(a: SparseMatrix): SparseCholeskyFactorization = portable.cholesky(a)

    final override fun quasiDefiniteLdl(a: SparseMatrix): QuasiDefiniteLdlFactorization {
    ...
    protected open fun quasiDefiniteLdlNative(a: SparseMatrix): QuasiDefiniteLdlFactorization =
        portable.quasiDefiniteLdl(a)

    final override fun qr(a: SparseMatrix): SparseQrFactorization {
    ...
    protected open fun qrNative(a: SparseMatrix): SparseQrFactorization = portable.qr(a)
}
