 ...
 */
public class QuasiDefiniteUpLookingLdl internal constructor(
    override val n: Int,
    ...
    public companion object {
         ...
         */
        public fun factorLower(a: SparseMatrix): QuasiDefiniteUpLookingLdl {
        ...
        internal fun factorLower(a: SparseMatrix, symbolic: UpLookingSymbolic): QuasiDefiniteUpLookingLdl =
            factorTransposed(transposeCsc(a), symbolic)

        private fun factorTransposed(upper: SparseMatrix, symbolic: UpLookingSymbolic): QuasiDefiniteUpLookingLdl {
            val n = symbolic.n
            ...
            return QuasiDefiniteUpLookingLdl(n, colPtr, rowIdx, values, diagonal, failedAt)
        }
    }
}
