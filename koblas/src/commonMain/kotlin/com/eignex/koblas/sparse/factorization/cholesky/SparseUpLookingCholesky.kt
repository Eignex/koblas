 ...
 */
public class SparseUpLookingCholesky internal constructor(
    override val n: Int,
    private val colPtr: IntArray,
    private val rowIdx: IntArray,
    private val values: DoubleArray,
) : SparseCholeskyFactorization {
    ...
    public companion object {
         ...
         */
        public fun factorLower(a: SparseMatrix): SparseUpLookingCholesky {
        ...
        internal fun factorLower(a: SparseMatrix, symbolic: UpLookingSymbolic): SparseUpLookingCholesky =
            factorTransposed(transposeCsc(a), symbolic)

        private fun factorTransposed(upper: SparseMatrix, symbolic: UpLookingSymbolic): SparseUpLookingCholesky {
            val n = symbolic.n
            ...
            return SparseUpLookingCholesky(n, colPtr, rowIdx, values)
        }
    }
}
