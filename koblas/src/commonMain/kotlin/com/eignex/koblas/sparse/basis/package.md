...
- [ProductFormBasisSolver] — the portable answer, a sparse LU plus one elementary transform per pivot.
...
- [BasisSolvers] — the backend half. It is separate from [com.eignex.koblas.sparse.SparseLapack] because
...
This is the counterpart of [com.eignex.koblas.sparse.BasisFactorization], which factors a basis a caller
