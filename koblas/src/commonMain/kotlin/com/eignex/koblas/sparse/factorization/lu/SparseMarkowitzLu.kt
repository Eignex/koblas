 ...
 */
public class SparseMarkowitzLu private constructor(
    private val m: Int,
    ...
    /** Always [NOT_SINGULAR]: a [SparseMarkowitzLu] only exists for a matrix that factored completely. */
    ...
    public companion object {
        ...
        internal fun factorCsc(
            ...
            requireSquare(a, "SparseMarkowitzLu")
