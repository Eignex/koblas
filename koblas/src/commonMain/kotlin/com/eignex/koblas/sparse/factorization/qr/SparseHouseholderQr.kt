...
import com.eignex.koblas.dense.MACHINE_EPSILON
 ...
 */
public class SparseHouseholderQr internal constructor(
    override val m: Int,
    override val n: Int,
    ...
    public companion object {
        ...
        public fun factor(a: SparseMatrix): SparseHouseholderQr = factor(a, analyze(a))
        ...
        internal fun factor(a: SparseMatrix, symbolic: SparseQrSymbolic): SparseHouseholderQr {
...
private fun numericalRank(m: Int, n: Int, colPtr: IntArray, values: DoubleArray): Int {
    ...
    val tolerance = maxOf(m, n) * MACHINE_EPSILON * maximum
    var rank = 0
