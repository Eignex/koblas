...
public class LuDecomposition(
    ...
    /**
     * Whether a zero pivot was encountered. [LinearAlgebra.solve] then throws
...
/** `det(A)` as sign(P) times the product of the U(k, k), or exactly `0.0` when [LuDecomposition.singular].
