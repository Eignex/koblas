...
- [F64VectorKernels] — the level-1 kernels (`dot`, `axpy`, `scale`, `nrm2`, `asum`). These are specialized
...
- [F64LinearAlgebra] pairs [F64Blas] and [F64Lapack]; the two are ranked and selected independently, so a host
