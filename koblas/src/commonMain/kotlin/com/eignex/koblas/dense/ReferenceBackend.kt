...
import com.eignex.koblas.RebindableBackend
import com.eignex.koblas.internal.backend.BackendNames
import com.eignex.koblas.koblas

/**
 * Portable pure-Kotlin backend, correct on every target with no native dependency, and the semantic
 * reference a native backend is validated against. The routines themselves live in [PortableBlas].
 *
...
public class ReferenceBackend(private val configured: Kernels? = null) :
    RebindableBackend,
    Blas by PortableBlas(configured) {
...
public val ReferenceBlas: ReferenceBackend = ReferenceBackend()
