...
//   - a runtime route to a registered [VectorKernels] backend, for runs long enough that a foreign call pays
 ...
 *
 * No [VectorKernels] counterpart, and no routing: BLAS has no batched-dot routine, so there is nothing to route
