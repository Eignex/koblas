...
public class BundledSuperlu private constructor(private val delegate: SuperluSparseLu) : F64SparseLu by delegate {
...
private fun loadSuperlu(driver: SuperluDriver): SuperluSparseLu {
